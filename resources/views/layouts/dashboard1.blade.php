...
<div class="container px-5 py-4">
    <div class="d-flex justify-content-between pb-2">
        <div class="btn-group dropend d-flex align-items-center m-0">
            <button class="btn dropdown-toggle p-0 text-dark fs-4 bg-transparent border-0 sortTable" type="button" data-bs-toggle="dropdown">
                {{ Auth::user()->role === 'admin' ? 'List of Tickets' : 'My Tickets' }} (sort by)
            </button>
